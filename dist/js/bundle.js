...
// Module
exports.push([module.i, "body{background:#ddd;display:flex}section ol#messageList{max-width:700px;margin:0 auto;list-style:none;background:#f5f5f5;border-top:1px solid #ccc}section ol#messageList li{padding:16px;border-bottom:1px solid #ccc}.example{display:grid;transition:all .5s;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;background:linear-gradient(180deg,#fff,#000)}", ""]);
